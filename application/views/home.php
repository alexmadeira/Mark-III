	...
	<div class="container-fluid main">
    	<header class="row header">
			<section class="container">
				...
				<p>Oi, meu nome é <strong>Alex Madeira</strong>, sou um <strong>Web Solution Developer</strong> & <strong>SEO analyst</strong>, que é só um nome bonito para um desenvolvedor que <strong>resolve</strong> seus problemas e tem um grande conhecimento em <strong>SEO</strong>.</p>
				<nav>
					<ul class="nav">
						<li>
